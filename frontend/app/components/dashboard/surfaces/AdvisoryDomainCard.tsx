...
export type AdvisoryDomainCardProps = {
  domain: string;
  title: string;
  primaryValue: string;
...
export function AdvisoryDomainCard(props: AdvisoryDomainCardProps): React.ReactElement {
  const { domain, title, primaryValue, secondaryValue, meta } = props;

  return (
    <div
      data-nx="advisory-domain-card"
      data-domain={domain}
      style={{
        display: "flex",
...
export default AdvisoryDomainCard;
