...
export type RiskDomainCardProps = {
  domain: string;
  title: string;
  primaryValue: string;
...
export function RiskDomainCard(props: RiskDomainCardProps): React.ReactElement {
  const { domain, title, primaryValue, secondaryValue, meta } = props;

  return (
    <div
      data-nx="risk-domain-card"
      data-domain={domain}
      style={{
        display: "flex",
