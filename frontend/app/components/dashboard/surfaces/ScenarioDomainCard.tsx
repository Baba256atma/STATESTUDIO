...
export type ScenarioDomainCardProps = {
  domain: string;
  title: string;
  primaryValue: string;
...
export function ScenarioDomainCard(props: ScenarioDomainCardProps): React.ReactElement {
  const { domain, title, primaryValue, secondaryValue, meta } = props;

  return (
    <div
      data-nx="scenario-domain-card"
      data-domain={domain}
      style={{
        display: "flex",
...
export default ScenarioDomainCard;
