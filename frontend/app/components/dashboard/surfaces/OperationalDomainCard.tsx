...
export type OperationalDomainCardProps = {
  domain: string;
  title: string;
  primaryValue: string;
...
export function OperationalDomainCard(props: OperationalDomainCardProps): React.ReactElement {
  const { domain, title, primaryValue, secondaryValue, meta } = props;

  return (
    <div
      data-nx="operational-domain-card"
      data-domain={domain}
      style={{
        display: "flex",
