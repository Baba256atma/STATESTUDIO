...
import { EXECUTIVE_INBOX_PLATFORM_ALLOWED_FUTURE_EXTENSIONS, EXECUTIVE_INBOX_PLATFORM_FORBIDDEN_CHANGES, EXECUTIVE_INBOX_PLATFORM_FREEZE_DOCUMENTATION_FILES, EXECUTIVE_INBOX_PLATFORM_FROZEN_PHASES, EXECUTIVE_INBOX_PLATFORM_FROZEN_PUBLIC_APIS, EXECUTIVE_INBOX_PLATFORM_PUBLIC_CONTRACT_REGISTRY, getExecutiveInboxPlatformRegistry } from "./executiveInboxPlatformFreezeRegistry.ts";
import type {
