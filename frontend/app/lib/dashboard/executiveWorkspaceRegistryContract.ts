...
> = Object.freeze({
  ...
  scenario: Object.freeze({
    ...
    availability: "available",
    lifecycleType: "session",
    description: "Scenario exploration workspace shell.",
    shellComponent: "ScenarioWorkspaceShell",
    routeContract: "scenario/scenarioModeContract.ts",
    futureCapabilityFlags: Object.freeze([]),
  }),
  war_room: Object.freeze({
    ...
    availability: "available",
    lifecycleType: "session",
    description: "Operational war room workspace shell.",
    shellComponent: "WarRoomWorkspaceShell",
    routeContract: "warRoom/warRoomModeContract.ts",
    futureCapabilityFlags: Object.freeze([]),
  }),
  risk: Object.freeze({
    id: "risk",
    ...
    availability: "future",
    lifecycleType: "session",
    description: "Future risk executive workspace — placeholder only.",
    shellComponent: null,
    routeContract: "risk/riskModeContract.ts",
  ...
  timeline: Object.freeze({
    ...
    availability: "future",
    lifecycleType: "session",
    description: "Future timeline executive workspace — placeholder only.",
    shellComponent: null,
    routeContract: "timeline/timelineModeContract.ts",
  ...
  governance: Object.freeze({
    ...
    availability: "future",
    lifecycleType: "session",
    description: "Future governance executive workspace — placeholder only.",
    shellComponent: null,
    routeContract: "governance/governanceModeContract.ts",
    futureCapabilityFlags: Object.freeze(["policy_constraints", "accountability"]),
  }),
