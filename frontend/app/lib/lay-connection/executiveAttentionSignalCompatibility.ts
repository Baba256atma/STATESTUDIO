...
import type { ExecutiveAttentionSignalCompatibility } from "./executiveAttentionSignalTypes.ts";

export function getExecutiveAttentionSignalCompatibilityMatrix(): readonly ExecutiveAttentionSignalCompatibility[] {
  ...
  return Object.freeze([
    ...
    Object.freeze({ platformId: "APP-REASON", compatible: reasoningState.status === "PASS", required: true, mode: "certified", notes: Object.freeze(["Certified reasoning signal source metadata."] as const) }),
    Object.freeze({ platformId: "APP-JUDGE", compatible: judgmentState.status === "PASS", required: true, mode: "certified", notes: Object.freeze(["Certified judgment signal source metadata."] as const) }),
    Object.freeze({ platformId: "EXECUTIVE-RECOMMENDATION", compatible: true, required: false, mode: "future-compatible", notes: Object.freeze(["Recommendation signals are future-compatible metadata only."] as const) }),
    Object.freeze({ platformId: "EXECUTIVE-EXPLANATION", compatible: true, required: false, mode: "future-compatible", notes: Object.freeze(["Explanation signals are future-compatible metadata only."] as const) }),
    Object.freeze({ platformId: "KNL", compatible: true, required: false, mode: "future-compatible", notes: Object.freeze(["Knowledge signals are future-compatible metadata only."] as const) }),
    Object.freeze({ platformId: "IDN", compatible: true, required: false, mode: "future-compatible", notes: Object.freeze(["Identity signals are future-compatible metadata only."] as const) }),
    Object.freeze({ platformId: "SMM", compatible: true, required: false, mode: "future-compatible", notes: Object.freeze(["Shared mental model signals are future-compatible metadata only."] as const) }),
    Object.freeze({ platformId: "ASS", compatible: true, required: false, mode: "future-compatible", notes: Object.freeze(["Assistant signals are future-compatible metadata only."] as const) }),
  ]);
}
