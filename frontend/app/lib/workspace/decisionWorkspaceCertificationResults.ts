/** WS-4:7 — Immutable Certification result vocabulary. */
...
export const DecisionWorkspaceCertificationResults = Object.freeze(
  definitions.map(
    ([name, terminalState, readinessEffect], index) => Object.freeze({
      id: `WS-4:7/Result/${String(index + 1).padStart(2, "0")}`,
      name,
