/** WS-9:7 — Immutable declarative Certification guarantees. */
...
export const ValueWorkspaceCertificationGuarantees = Object.freeze(
  names.map((name, index) => Object.freeze({
    id: `WS-9:7/Guarantee/${String(index + 1).padStart(2, "0")}`,
    name,
    state: "Guaranteed",
