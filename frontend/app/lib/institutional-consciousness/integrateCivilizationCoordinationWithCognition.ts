...
import type { CivilizationCoordinationResult } from "./civilizationCoordinationTypes";
...
/**
 * D9:8:7 — Passive strategic civilization coordination + macro-institutional harmony awareness.
 * Civilization Adaptation Intelligence → Civilization Coordination Intelligence → Macro-Institutional Harmony Awareness
 */
export function integrateCivilizationCoordinationWithCognition(params: {
  ...
  return evaluateCivilizationCoordinationIntelligence({
    organizationId,
