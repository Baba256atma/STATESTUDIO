...
import type { CivilizationFragilityResult } from "./civilizationFragilityTypes";
...
/**
 * D9:8:3 — Passive civilization fragility propagation + macro-systemic resilience awareness.
 * Ecosystem Synchronization → Civilization Fragility Propagation → Macro-Systemic Resilience Awareness
 */
export function integrateCivilizationFragilityWithCognition(params: {
  ...
  return evaluateCivilizationFragilityPropagation({
    organizationId,
