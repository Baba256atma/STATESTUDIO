...
import { CROSS_SCENARIO_LEARNING_PLATFORM_ALLOWED_FUTURE_EXTENSIONS, CROSS_SCENARIO_LEARNING_PLATFORM_FORBIDDEN_CHANGES, CROSS_SCENARIO_LEARNING_PLATFORM_FREEZE_DOCUMENTATION_FILES, CROSS_SCENARIO_LEARNING_PLATFORM_FROZEN_PHASES, CROSS_SCENARIO_LEARNING_PLATFORM_FROZEN_PUBLIC_APIS, CROSS_SCENARIO_LEARNING_PLATFORM_PUBLIC_CONTRACT_REGISTRY, getCrossScenarioLearningPlatformRegistry } from "./crossScenarioLearningPlatformFreezeRegistry.ts";
import type {
