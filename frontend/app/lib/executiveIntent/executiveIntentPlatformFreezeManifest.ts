...
import {
  ...
  PLATFORM_CERTIFICATION_FUTURE_EXTENSION,
...
export const EXECUTIVE_INTENT_PLATFORM_FREEZE_VERSION = "APP-3/15" as const;
export const EXECUTIVE_INTENT_PLATFORM_STATUS = "FROZEN" as const;
...
export type ExecutiveIntentPlatformFreezeManifest = Readonly<{
  ...
  platformVersion: typeof EXECUTIVE_INTENT_PLATFORM_FREEZE_VERSION;
  ...
  frozenPublicSurface: typeof EXECUTIVE_INTENT_PLATFORM_FROZEN_PUBLIC_SURFACE;
  frozenPublicApis: readonly string[];
  supportedConsumers: typeof EXECUTIVE_INTENT_PLATFORM_SUPPORTED_CONSUMERS;
  internalDependencies: typeof EXECUTIVE_INTENT_PLATFORM_INTERNAL_DEPENDENCIES;
  forbiddenConsumerImports: typeof EXECUTIVE_INTENT_PLATFORM_FORBIDDEN_CONSUMER_IMPORTS;
  ...
  futureExtensionPolicy: typeof EXECUTIVE_INTENT_PLATFORM_FUTURE_EXTENSION_POLICY;
  compatibilityManifest: typeof EXECUTIVE_INTENT_PLATFORM_COMPATIBILITY_MANIFEST;
  futureCompatibility: typeof EXECUTIVE_INTENT_FUTURE_COMPATIBILITY;
  reservedExtensions: typeof PLATFORM_CERTIFICATION_FUTURE_EXTENSION;
  releaseTags: typeof EXECUTIVE_INTENT_PLATFORM_RELEASE_TAGS;
...
export function buildExecutiveIntentPlatformFreezeManifest(
  certificationDate: string
