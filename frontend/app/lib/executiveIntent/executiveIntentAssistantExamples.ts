...
export type ExecutiveIntentAssistantCanonicalExample = Readonly<{
  exampleId: string;
  label: string;
...
export const EXECUTIVE_INTENT_ASSISTANT_CANONICAL_EXAMPLES: readonly ExecutiveIntentAssistantCanonicalExample[] =
  Object.freeze([
    Object.freeze({
...
export function getExecutiveIntentAssistantCanonicalExample(
  exampleId: string
): ExecutiveIntentAssistantCanonicalExample | null {
  return (
    EXECUTIVE_INTENT_ASSISTANT_CANONICAL_EXAMPLES.find((entry) => entry.exampleId === exampleId) ??
    null
  );
}
