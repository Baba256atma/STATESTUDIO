...
import type {
  ExecutiveIntent,
  ExecutiveIntentFutureCompatibility,
  ExecutiveIntentPlatformIdentity,
  IntentMetadata,
  IntentScopeDescriptor,
  IntentVersion,
...
export const EXECUTIVE_INTENT_IDENTITY: ExecutiveIntentPlatformIdentity = Object.freeze({
  appId: "APP-3",
...
export const EXECUTIVE_INTENT_MODULE_PATHS = Object.freeze(
  EXECUTIVE_INTENT_SELF_MANIFEST.allowedFiles.filter((entry) => entry.endsWith(".ts"))
);
...
export function createIntentVersionExample(timestamp: string): IntentVersion {
...
export function createIntentScopeExample(): IntentScopeDescriptor {
  return Object.freeze({
    scope: "enterprise",
...
export function resolveExecutiveIntentMetadataExample(
  ...
  return Object.freeze({
    ...
    description:
      "Metadata-only contract example describing what the executive is trying to achieve.",
    createdAt: timestamp,
    updatedAt: timestamp,
    ...
    tags: Object.freeze([
      Object.freeze({ tagId: "tag-strategic", label: "Strategic", readOnly: true as const }),
    ]),
    priority: "high",
    status: "active",
...
export function resolveExecutiveIntentExample(
  timestamp: string = new Date(0).toISOString()
): ExecutiveIntent {
...
export function getExecutiveIntentFutureCompatibility(): ExecutiveIntentFutureCompatibility {
  return EXECUTIVE_INTENT_FUTURE_COMPATIBILITY;
}

export function getExecutiveIntentContractVersionMetadata(): Readonly<{
  contractVersion: string;
  architectureVersion: string;
  platform: typeof EXECUTIVE_INTENT_PLATFORM;
  owner: typeof EXECUTIVE_INTENT_SOURCE;
}> {
  return Object.freeze({
    contractVersion: EXECUTIVE_INTENT_CONTRACT_VERSION,
    architectureVersion: EXECUTIVE_INTENT_ARCHITECTURE_VERSION,
