...
import type { UnifiedStrategicResonanceResult } from "./strategicResonanceTypes";

/**
 * D9:9:8 — Passive unified enterprise strategic resonance intelligence + cross-system harmonic alignment.
 * Strategic Equilibrium Intelligence → Strategic Resonance Intelligence
 */
export function integrateStrategicResonanceWithCognition(params: {
  ...
  return evaluateUnifiedStrategicResonance({
    organizationId,
