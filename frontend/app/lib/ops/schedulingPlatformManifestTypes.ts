export interface SchedulingPlatformPhaseEntry {
...
export interface SchedulingPlatformDependencyEntry {
...
export interface SchedulingPlatformPublicSurfaceEntry {
...
export interface SchedulingPlatformManifestDescriptor {
