/** Shared reality stack fixture for D7:7+ integration tests. */
...
export function sceneFixture(): SceneJson {
  return {
    state_vector: { intensity: 0.55, volatility: 0.42 },
    scene: {
      objects: [
...
export function buildRealityStack() {
...
export function realityInput(stack: ReturnType<typeof buildRealityStack>) {
  return {
