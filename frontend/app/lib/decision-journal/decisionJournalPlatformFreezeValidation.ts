...
import { DECISION_JOURNAL_PLATFORM_ALLOWED_FUTURE_EXTENSIONS, DECISION_JOURNAL_PLATFORM_FORBIDDEN_CHANGES, DECISION_JOURNAL_PLATFORM_FREEZE_DOCUMENTATION_FILES, DECISION_JOURNAL_PLATFORM_FROZEN_PHASES, DECISION_JOURNAL_PLATFORM_FROZEN_PUBLIC_APIS, DECISION_JOURNAL_PLATFORM_PUBLIC_CONTRACT_REGISTRY, getDecisionJournalPlatformRegistry } from "./decisionJournalPlatformFreezeRegistry.ts";
import type {
