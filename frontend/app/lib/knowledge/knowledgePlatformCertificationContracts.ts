...
import { CERTIFICATION_GATE_KEYS, CERTIFICATION_SCOPE_KEYS, KNL_CERTIFICATION_PHASE_KEYS, KNOWLEDGE_PLATFORM_CERTIFICATION_ARCHITECTURE_VERSION, KNOWLEDGE_PLATFORM_CERTIFICATION_CONTRACT_VERSION, KNOWLEDGE_PLATFORM_CERTIFICATION_FORBIDDEN_PATTERNS, KNOWLEDGE_PLATFORM_CERTIFICATION_FUTURE_PHASE_KEYS, KNOWLEDGE_PLATFORM_CERTIFICATION_GOVERNANCE_RULES, KNOWLEDGE_PLATFORM_CERTIFICATION_MUST_NOT_OWN, KNOWLEDGE_PLATFORM_CERTIFICATION_NAMESPACE, KNOWLEDGE_PLATFORM_CERTIFICATION_PLATFORM_ID, KNOWLEDGE_PLATFORM_CERTIFICATION_PLATFORM_NAME, KNOWLEDGE_PLATFORM_CERTIFICATION_PRINCIPLES, KNOWLEDGE_PLATFORM_CERTIFICATION_PUBLIC_API_REGISTRY } from "./knowledgePlatformCertificationCatalog.ts";
import {
