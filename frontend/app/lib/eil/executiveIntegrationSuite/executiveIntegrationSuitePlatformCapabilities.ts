/**
 * EIL-8:6 — Executive Integration Suite Platform Capabilities.
 *
...
export type SuitePlatformCapabilityKey =
...
export interface ExecutiveIntegrationSuitePlatformCapability {
  readonly capabilityId: `EIL-8:6/Capability/${SuitePlatformCapabilityKey}`;
  readonly canonicalKey: SuitePlatformCapabilityKey;
...
const capability = (
  key: SuitePlatformCapabilityKey,
  canonicalName: string,
  description: string,
  order: number,
): ExecutiveIntegrationSuitePlatformCapability =>
  Object.freeze({
    capabilityId: `EIL-8:6/Capability/${key}` as const,
    canonicalKey: key,
    canonicalName,
    description,
    order,
 ...
 */
export const ExecutiveIntegrationSuitePlatformCapabilities: readonly ExecutiveIntegrationSuitePlatformCapability[] =
  Object.freeze([
    capability(
      "FoundationComposition",
    ...
    capability(
      ...
      "Preserves canonical EIL-8 architecture integrity.",
      16,
    ),
    capability(
      "PlatformPackaging",
