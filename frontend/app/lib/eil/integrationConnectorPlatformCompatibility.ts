/**
 * EIL-2:6 — Integration Connector Platform Compatibility.
 *
...
import type {
  IntegrationConnectorPlatformCompatibilityDeclaration,
  IntegrationConnectorPlatformCompatibilityScope,
} from "./integrationConnectorPlatformTypes.ts";

const declaration = (
  key: string,
  scope: IntegrationConnectorPlatformCompatibilityScope,
  ...
  Object.freeze({
    compatibilityId: `EIL-2:6/Compatibility/${key}` as const,
    scope,
    canonicalKey: key,
    canonicalName,
    description,
 ...
 */
export const IntegrationConnectorPlatformCompatibility: readonly IntegrationConnectorPlatformCompatibilityDeclaration[] =
  Object.freeze([
    declaration(
    ...
    declaration(
      ...
      `Compatible with ${IntegrationConnectorManifestIdentity.canonicalId} at ${IntegrationConnectorManifestIdentity.version}; Manifest declares ${IntegrationConnectorCompatibilityManifest.declarationCount} scopes.`,
      5,
    ...
    declaration(
      ...
      "Semantic version 1.0.0 lineage compatibility preserved across EIL-2.",
      7,
    ...
    declaration(
      ...
      "Metadata-only architecture preserved across the complete EIL-2 ladder.",
      10,
