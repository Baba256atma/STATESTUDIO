/**
 * EIL-4:7 — Integration Orchestration Compliance Declarations.
 *
...
import type {
  IntegrationOrchestrationComplianceDeclaration,
  OrchestrationComplianceKey,
} from "./integrationOrchestrationCertificationTypes.ts";

const compliance = (
  key: OrchestrationComplianceKey,
  canonicalName: string,
  description: string,
  ordinal: number,
): IntegrationOrchestrationComplianceDeclaration =>
  Object.freeze({
    complianceId: `EIL-4:7/Compliance/${key}` as const,
    canonicalKey: key,
    canonicalName,
    description,
 ...
 */
export const IntegrationOrchestrationComplianceDeclarations: readonly IntegrationOrchestrationComplianceDeclaration[] =
  Object.freeze([
    compliance(
      "MetadataOnlyCompliance",
      "Metadata-only Compliance",
      "EIL-4 remains metadata-only through Platform certification.",
      1,
    ),
    compliance(
      "CanonicalNamingCompliance",
      "Canonical Naming Compliance",
      "Canonical IDs and namespaces follow nexora.eil.integration-orchestration.* conventions.",
      2,
    ),
    compliance(
    ...
    compliance(
      ...
      "Certification consumes only integrationOrchestrationPlatform.ts.",
      8,
    ),
    compliance(
