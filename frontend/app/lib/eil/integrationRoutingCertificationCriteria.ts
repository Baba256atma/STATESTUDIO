/**
 * EIL-3:7 — Integration Routing Certification Criteria.
 *
 * Immutable declarative certification criteria for the EIL-3 Routing Platform.
...
import type {
  RoutingCertificationCriterion,
  RoutingCertificationCriterionCategory,
  RoutingCertificationCriterionKey,
  RoutingCertificationExpectedOutcome,
  RoutingCertificationSeverity,
...
const criterion = (
  key: RoutingCertificationCriterionKey,
  canonicalName: string,
  description: string,
  category: RoutingCertificationCriterionCategory,
  expectedOutcome: RoutingCertificationExpectedOutcome,
  severity: RoutingCertificationSeverity,
  sourcePath: string,
  ordinal: number,
  tags: readonly string[],
): RoutingCertificationCriterion =>
  Object.freeze({
    criterionId: `EIL-3:7/Criterion/${key}` as const,
    canonicalKey: key,
    canonicalName,
    description,
    category,
 ...
 */
export const IntegrationRoutingCertificationCriteria: readonly RoutingCertificationCriterion[] =
  Object.freeze([
    criterion(
      "CanonicalIdentity",
      "Canonical Identity",
      "Platform canonical identity must equal EIL-3:6/IntegrationRoutingPlatform.",
      "Identity",
      "Present",
      "Error",
      "identity",
    ...
    criterion(
      "NamespaceIntegrity",
      "Namespace Integrity",
      "Platform namespace must equal nexora.eil.integration-routing.platform.",
      "Namespace",
      "Valid",
      "Error",
      "identity/namespace",
    ...
    criterion(
      ...
      "Platform must reference EIL-3:5/IntegrationRoutingManifest without duplication.",
      "Manifest",
      "Complete",
      "Error",
    ...
    criterion(
      ...
      "IntegrationRoutingPlatform must remain the sole Platform consumer entry point.",
      "Export",
      "Present",
      "Error",
      "summary",
    ...
    criterion(
      ...
      "Platform must remain free of runtime, networking, and routing engine behavior.",
      "Compliance",
      "Compliant",
      "Error",
      "metadataOnly",
    ...
    criterion(
      "ReleaseConsistency",
      "Release Consistency",
      "Release lineage and version consistency must be preserved across EIL-3.",
      "Release",
      "Compliant",
      "Error",
