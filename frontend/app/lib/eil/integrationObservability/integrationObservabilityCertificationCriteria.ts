/**
 * EIL-6:7 — Integration Observability Certification Criteria.
 *
...
export type ObservabilityCertificationCriterionKey =
...
export interface IntegrationObservabilityCertificationCriterion {
  readonly criterionId: `EIL-6:7/Criterion/${ObservabilityCertificationCriterionKey}`;
  readonly canonicalKey: ObservabilityCertificationCriterionKey;
...
const criterion = (
  key: ObservabilityCertificationCriterionKey,
  canonicalName: string,
  description: string,
  order: number,
): IntegrationObservabilityCertificationCriterion =>
  Object.freeze({
    criterionId: `EIL-6:7/Criterion/${key}` as const,
    canonicalKey: key,
    canonicalName,
    description,
    order,
 ...
 */
export const IntegrationObservabilityCertificationCriteria: readonly IntegrationObservabilityCertificationCriterion[] =
  Object.freeze([
    criterion(
      "CanonicalIdentityCertified",
    ...
    criterion(
      "NamespaceCertified",
      "Namespace Certified",
      "Canonical Observability namespaces are certified.",
      2,
    ),
    criterion(
      "DependencyIntegrityCertified",
    ...
    criterion(
      ...
      "Canonical EIL-6 architecture integrity is certified.",
      15,
    ),
    criterion(
      "RuntimeIndependenceCertified",
      "Runtime Independence Certified",
      "Runtime-free observability independence is certified.",
      16,
    ),
    criterion(
      "PlatformReadinessCertified",
