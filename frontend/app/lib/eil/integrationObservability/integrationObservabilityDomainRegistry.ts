/**
 * EIL-6:2 — Integration Observability Domain Registry.
 *
 * Canonical registry for the ten Foundation observability domains.
...
export interface IntegrationObservabilityDomainRegistryRecord {
  readonly id: `EIL-6:2/Domain/${string}`;
  readonly key: string;
 ...
 */
export const IntegrationObservabilityDomainRegistry: readonly IntegrationObservabilityDomainRegistryRecord[] =
  Object.freeze(
    foundation.domains.map((item) =>
      Object.freeze({
        id: `EIL-6:2/Domain/${item.domainKey}` as const,
        key: item.domainKey,
