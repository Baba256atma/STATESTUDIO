/**
 * EIL-6:2 — Integration Observability Capability Registry.
 *
 * Canonical registry for the ten Foundation observability capabilities.
...
export interface IntegrationObservabilityCapabilityRegistryRecord {
  readonly id: `EIL-6:2/Capability/${string}`;
  readonly key: string;
 ...
 */
export const IntegrationObservabilityCapabilityRegistry: readonly IntegrationObservabilityCapabilityRegistryRecord[] =
  Object.freeze(
    foundation.capabilityDeclarations.map((item) =>
      Object.freeze({
        id: `EIL-6:2/Capability/${item.capabilityKey}` as const,
