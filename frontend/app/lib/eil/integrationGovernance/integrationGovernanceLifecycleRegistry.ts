/**
 * EIL-7:2 — Integration Governance Lifecycle Registry.
 *
...
export interface IntegrationGovernanceLifecycleRegistryRecord {
  readonly id: `EIL-7:2/Lifecycle/${string}`;
  readonly key: string;
 ...
 */
export const IntegrationGovernanceLifecycleRegistry: readonly IntegrationGovernanceLifecycleRegistryRecord[] =
  Object.freeze(
    foundation.lifecycle.states.map((state, index) =>
      Object.freeze({
        id: `EIL-7:2/Lifecycle/${state}` as const,
        key: state,
        name: state,
