/**
 * EIL-7:5 — Integration Governance Manifest Compatibility.
 *
...
export type GovernanceManifestCompatibilityKey =
...
export interface IntegrationGovernanceManifestCompatibilityDeclaration {
  readonly compatibilityId: `EIL-7:5/Compatibility/${GovernanceManifestCompatibilityKey}`;
  readonly canonicalKey: GovernanceManifestCompatibilityKey;
...
const compatibility = (
  key: GovernanceManifestCompatibilityKey,
  canonicalName: string,
  description: string,
  order: number,
): IntegrationGovernanceManifestCompatibilityDeclaration =>
  Object.freeze({
    compatibilityId: `EIL-7:5/Compatibility/${key}` as const,
    canonicalKey: key,
    canonicalName,
    description,
    order,
 ...
 */
export const IntegrationGovernanceManifestCompatibility: readonly IntegrationGovernanceManifestCompatibilityDeclaration[] =
  Object.freeze([
    compatibility(
      "FoundationCompatible",
      "Foundation Compatible",
      "Compatible with EIL-7:1 Integration Governance Foundation architecture.",
      1,
    ),
    compatibility(
      "RegistryCompatible",
      "Registry Compatible",
      "Compatible with EIL-7:2 Integration Governance Registry architecture.",
      2,
    ),
    compatibility(
      "ModelCompatible",
      "Model Compatible",
      "Compatible with EIL-7:3 Integration Governance Model architecture.",
      3,
    ),
    compatibility(
      "ValidationCompatible",
      "Validation Compatible",
      "Compatible with EIL-7:4 Integration Governance Validation architecture.",
      4,
    ),
    compatibility(
      "PlatformCompatible",
