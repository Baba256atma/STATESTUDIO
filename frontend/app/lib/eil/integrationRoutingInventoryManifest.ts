/**
 * EIL-3:5 — Integration Routing Inventory Manifest.
 *
...
import { IntegrationRoutingValidationPlatform } from "./integrationRoutingValidation.ts";
import type { RoutingInventoryManifest } from "./integrationRoutingManifestTypes.ts";
 ...
 */
export const IntegrationRoutingInventoryManifest: RoutingInventoryManifest =
  Object.freeze({
    inventoryId: "EIL-3:5/Inventory",
    foundationCategoryCount,
    foundationContractCount,
    foundationCapabilityCount,
    foundationResponsibilityCount,
