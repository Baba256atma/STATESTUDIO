/** ASSISTANT-7:7 — Exactly 16 immutable certification gates. */
import type { AssistantExecutiveActionPlanningCertificationGateMetadata } from "./assistantExecutiveActionPlanningCertification.types.ts";
...
const gates = Object.freeze([
  ...
  },
  {
    ...
    description:
      "Gate confirming architecture-consistency certification.",
  },
  {
    name: "Consumer Readiness Gate",
    description:
      "Gate confirming consumer-readiness certification.",
  },
  {
...
export const AssistantExecutiveActionPlanningCertificationGates:
readonly AssistantExecutiveActionPlanningCertificationGateMetadata[] =
  Object.freeze(
    gates.map((gate, index) => Object.freeze({
      gateId: `ASSISTANT-7:7/Gate/${String(index + 1).padStart(2, "0")}`,
      name: gate.name,
