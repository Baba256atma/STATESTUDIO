/** ASSISTANT-1:7 — Exactly 16 immutable certification gates. */
import type { AssistantConversationCertificationGateMetadata } from "./assistantConversationCertification.types.ts";
...
export const AssistantConversationCertificationGates:
readonly AssistantConversationCertificationGateMetadata[] = Object.freeze(
  gates.map((gate, index) => Object.freeze({
    gateId: `ASSISTANT-1:7/Gate/${String(index + 1).padStart(2, "0")}`,
    name: gate.name,
