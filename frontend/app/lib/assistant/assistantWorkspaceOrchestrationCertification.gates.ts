/** ASSISTANT-5:7 — Exactly 16 immutable certification gates. */
import type { AssistantWorkspaceOrchestrationCertificationGateMetadata } from "./assistantWorkspaceOrchestrationCertification.types.ts";
...
export const AssistantWorkspaceOrchestrationCertificationGates:
readonly AssistantWorkspaceOrchestrationCertificationGateMetadata[] =
  Object.freeze(
    gates.map((gate, index) => Object.freeze({
      gateId: `ASSISTANT-5:7/Gate/${String(index + 1).padStart(2, "0")}`,
      name: gate.name,
