/** ASSISTANT-2:7 — Exactly 16 immutable certification gates. */
import type { AssistantExecutiveMemoryCertificationGateMetadata } from "./assistantExecutiveMemoryCertification.types.ts";
...
export const AssistantExecutiveMemoryCertificationGates:
readonly AssistantExecutiveMemoryCertificationGateMetadata[] = Object.freeze(
  gates.map((gate, index) => Object.freeze({
    gateId: `ASSISTANT-2:7/Gate/${String(index + 1).padStart(2, "0")}`,
    name: gate.name,
