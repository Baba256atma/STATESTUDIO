/** ASSISTANT-3:7 — Exactly 16 immutable certification gates. */
import type { AssistantIntentDialogueCertificationGateMetadata } from "./assistantIntentDialogueCertification.types.ts";
...
export const AssistantIntentDialogueCertificationGates:
readonly AssistantIntentDialogueCertificationGateMetadata[] = Object.freeze(
  gates.map((gate, index) => Object.freeze({
    gateId: `ASSISTANT-3:7/Gate/${String(index + 1).padStart(2, "0")}`,
    name: gate.name,
