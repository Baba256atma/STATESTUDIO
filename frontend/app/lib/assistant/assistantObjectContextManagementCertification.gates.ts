/** ASSISTANT-6:7 — Exactly 16 immutable certification gates. */
import type { AssistantObjectContextManagementCertificationGateMetadata } from "./assistantObjectContextManagementCertification.types.ts";
...
export const AssistantObjectContextManagementCertificationGates:
readonly AssistantObjectContextManagementCertificationGateMetadata[] =
  Object.freeze(
    gates.map((gate, index) => Object.freeze({
      gateId: `ASSISTANT-6:7/Gate/${String(index + 1).padStart(2, "0")}`,
      name: gate.name,
