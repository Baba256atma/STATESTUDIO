/** ASSISTANT-5:5 — Validation-derived immutable Manifest inventories. */
import { AssistantWorkspaceOrchestrationValidation } from "./assistantWorkspaceOrchestrationValidation.ts";
import type { AssistantWorkspaceOrchestrationCompatibilityMetadata } from "./assistantWorkspaceOrchestrationManifest.types.ts";

const validation = AssistantWorkspaceOrchestrationValidation;
const model = validation.model;
const registry = model.registry;

export const AssistantWorkspaceOrchestrationManifestCompatibility:
AssistantWorkspaceOrchestrationCompatibilityMetadata = Object.freeze({
...
export const AssistantWorkspaceOrchestrationManifestInventory = Object.freeze({
  ...
  compatibilityInventory:
    AssistantWorkspaceOrchestrationManifestCompatibility,
