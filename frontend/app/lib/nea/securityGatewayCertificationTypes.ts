/**
 * NEA-4:7 — Security Gateway Certification Types.
 *
 * Readonly contracts for declarative Security Gateway certification.
 * Metadata-only. No runtime certification.
 *
 * Ownership: owned exclusively by NEA-4:7.
 */

/** Certification status for NEA-4:7. */
export type SecurityGatewayCertificationStatus = "Certification";

/** Immediate downstream readiness — Freeze only. */
export type SecurityGatewayCertificationReadiness = "ReadyForFreeze";

/** Certification gate identifiers — exactly seventeen. */
export type SecurityGatewayCertificationGateId =
  | "FoundationIntegrity"
  | "RegistryIntegrity"
  | "ModelIntegrity"
  | "ValidationIntegrity"
...
export type SecurityGatewayCertificationGateOutcome = "Pass" | "Fail";

/** Certification gate declaration. */
export interface SecurityGatewayCertificationGate {
  readonly gateId: SecurityGatewayCertificationGateId;
  readonly gateName: string;
  readonly description: string;
  readonly outcome: SecurityGatewayCertificationGateOutcome;
...
export interface SecurityGatewayComplianceDeclaration {
...
export interface SecurityGatewayCertificationIdentity {
  readonly certificationId: string;
  readonly certificationName: string;
  readonly certificationVersion: string;
  readonly certificationNamespace: string;
  readonly layer: "NEA";
  readonly phase: "NEA-4:7";
  readonly stage: "Certification";
  readonly sourcePhase: "NEA-4:7";
  readonly owner: string;
  readonly status: SecurityGatewayCertificationStatus;
  readonly readiness: SecurityGatewayCertificationReadiness;
...
export interface SecurityGatewayCertificationSummary {
  readonly certificationId: string;
