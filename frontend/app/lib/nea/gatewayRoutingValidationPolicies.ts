/**
 * NEA-5:4 — Gateway Routing Validation Policies.
 *
...
import type { GatewayRoutingValidationPolicy } from "./gatewayRoutingValidationTypes.ts";

/** Exactly eight declarative validation policies. */
export const GatewayRoutingValidationPolicies: readonly GatewayRoutingValidationPolicy[] =
  Object.freeze([
    Object.freeze({
      policyId: "NEA-5:4/Policy/CanonicalReferenceRequired",
    ...
    Object.freeze({
      policyId: "NEA-5:4/Policy/MetadataComplete",
    ...
    Object.freeze({
      policyId: "NEA-5:4/Policy/OwnershipPreserved",
    ...
    Object.freeze({
      policyId: "NEA-5:4/Policy/ImmutableModels",
    ...
    Object.freeze({
      policyId: "NEA-5:4/Policy/NoDuplicateDefinitions",
    ...
    Object.freeze({
      policyId: "NEA-5:4/Policy/NoRuntimeBehavior",
      policyName: "No Runtime Behavior",
      statement:
        "Validation definitions are declarative metadata only; no validation or routing engine is implemented.",
      executes: false as const,
      metadataOnly: true as const,
      immutable: true as const,
    ...
    Object.freeze({
      policyId: "NEA-5:4/Policy/NoDeepImports",
      policyName: "No Deep Imports",
      statement:
        "Validation imports only GatewayRoutingModelPlatform and never deep-imports Registry or Foundation.",
      executes: false as const,
      metadataOnly: true as const,
      immutable: true as const,
    ...
    Object.freeze({
      policyId: "NEA-5:4/Policy/PlatformIntegrity",
...
export const GatewayRoutingValidationPolicyCatalog = Object.freeze({
  catalogId: "NEA-5:4/ValidationPolicyCatalog",
  sourcePhase: "NEA-5:4" as const,
  policies: GatewayRoutingValidationPolicies,
  policyCount: GatewayRoutingValidationPolicies.length,
