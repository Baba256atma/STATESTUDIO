import type { VisualizationSuiteManifestGuarantee } from "./visualizationSuiteManifestTypes.ts";
...
export const VisualizationSuiteManifestGuarantees:
readonly VisualizationSuiteManifestGuarantee[] = Object.freeze(
  guaranteeNames.map((name, index) => Object.freeze({
    id: `EVE-9:5/Guarantee/${index + 1}` as const,
    name,
    description: `Declarative Manifest guarantee: ${name}.`,
    guaranteed: true as const,
    evidenceReference: VisualizationSuiteValidationPlatform.metadata.id,
