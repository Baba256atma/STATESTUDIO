...
import type { VisualizationSuitePlatformCompatibilityEntry } from "./visualizationSuitePlatformTypes.ts";
...
export const VisualizationSuitePlatformCompatibility:
readonly VisualizationSuitePlatformCompatibilityEntry[] = Object.freeze(
  compatibilitySources.map(([name, canonicalReference, canonicalSource], index) =>
    Object.freeze({
      id: `EVE-9:6/Compatibility/${index + 1}` as const,
      name,
