import type { VisualizationSuiteManifestCompatibilityEntry } from "./visualizationSuiteManifestTypes.ts";
...
export const VisualizationSuiteManifestCompatibility:
readonly VisualizationSuiteManifestCompatibilityEntry[] = Object.freeze(
  compatibilitySources.map(([name, canonicalReference, canonicalSource], index) =>
    Object.freeze({
      id: `EVE-9:5/Compatibility/${index + 1}` as const,
      name,
