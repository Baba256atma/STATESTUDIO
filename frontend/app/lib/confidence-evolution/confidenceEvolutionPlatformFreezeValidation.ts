...
import { CONFIDENCE_EVOLUTION_PLATFORM_ALLOWED_FUTURE_EXTENSIONS, CONFIDENCE_EVOLUTION_PLATFORM_FORBIDDEN_CHANGES, CONFIDENCE_EVOLUTION_PLATFORM_FREEZE_DOCUMENTATION_FILES, CONFIDENCE_EVOLUTION_PLATFORM_FROZEN_PHASES, CONFIDENCE_EVOLUTION_PLATFORM_FROZEN_PUBLIC_APIS, CONFIDENCE_EVOLUTION_PLATFORM_PUBLIC_CONTRACT_REGISTRY, getConfidenceEvolutionPlatformRegistry } from "./confidenceEvolutionPlatformFreezeRegistry.ts";
import type {
