...
import { buildScenarioIntelligencePlatformFreezeManifest, SCENARIO_INTELLIGENCE_PLATFORM_COMPATIBILITY_MANIFEST, SCENARIO_INTELLIGENCE_PLATFORM_FORBIDDEN_CONSUMER_IMPORTS, SCENARIO_INTELLIGENCE_PLATFORM_FREEZE_VERSION, SCENARIO_INTELLIGENCE_PLATFORM_STATUS } from "./scenarioIntelligencePlatformFreezeManifest.ts";
import {
