...
export const NLU_CERTIFICATION_CORPUS: readonly NluCorpusCase[] = Object.freeze([
  ...
  c("o27", "Delivery?", "fragment", { operation: "FOCUS", subjectName: "Delivery" }),
  c("o28", "Capacity?", "fragment", { operation: "FOCUS", subjectName: "Capacity" }),
  ...
  c("m4", "DELIVERY?", "mutation", { operation: "FOCUS", subjectName: "Delivery" }),
