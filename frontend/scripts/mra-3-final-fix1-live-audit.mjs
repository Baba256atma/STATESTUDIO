/**
 * MRA:3-FINAL-FIX1 live /executive referent parity.
...
const out = join(process.cwd(), "artifacts/mra/MRA-3-FINAL-FIX1");
...
try {
  ...
  const live = { identity: "NPA-T MRA:3-FINAL-FIX1/LiveReferentParity", url, errors, tests: {} };
