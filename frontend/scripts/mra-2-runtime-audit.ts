/**
 * MRA:2 runtime regression of the MRA:1 failure corpus. Does not rewrite MRA:1 evidence.
 */
...
const outDir = join(dirname(fileURLToPath(import.meta.url)), "../artifacts/mra/MRA-2");
...
const report = {
  identity: "NPA-T MRA:2/RuntimeManagerRegression",
