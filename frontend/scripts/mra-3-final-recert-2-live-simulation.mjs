/**
 * MRA:3 independent recertification (RECERT-2) — live /executive. Validation only.
 */
...
const out = join(process.cwd(), "artifacts/mra/MRA-3-FINAL-RECERT-2");
const LEAK =
...
try {
  ...
  const live = { identity: "NPA-T MRA:3-RECERT-2/LiveManagerSimulation", url, errors, checks: [], journeys: {} };
  ...
  live.journeys.historicalS1.push(await turn("tell me more about it"));
  live.checks.push(check(
    "S1-HIST-problem-more",
    live.journeys.historicalS1.at(-1).reply,
    /Capacity Gap/i,
    STEAL,
  ));
  ...
  live.checks.push(check("A-csv", live.journeys.crossDomain.at(-1).reply, /csv/i, STEAL));
  live.journeys.crossDomain.push(await turn("Capacity Gap"));
  live.journeys.crossDomain.push(await turn("explain it"));
  live.checks.push(check("B-problem", live.journeys.crossDomain.at(-1).reply, /Capacity Gap/i, STEAL));
  live.journeys.crossDomain.push(await turn("Demand Surge"));
  live.journeys.crossDomain.push(await turn("tell me more about it"));
  live.checks.push(check("C-surge", live.journeys.crossDomain.at(-1).reply, /Demand Surge/i, STEAL));
  ...
  live.checks.push(check("D-kpi", live.journeys.crossDomain.at(-1).reply, /Capacity/i, STEAL));
  ...
  await reset(false);
  live.journeys.deictic = [];
  live.journeys.deictic.push(await turn("Demand Surge"));
  live.journeys.deictic.push(await turn("explain it"));
  live.checks.push(check("deictic-explain", live.journeys.deictic.at(-1).reply, /Demand Surge/i, STEAL));
  live.journeys.deictic.push(await turn("tell me more about it"));
  live.checks.push(check("deictic-more", live.journeys.deictic.at(-1).reply, /Demand Surge/i, STEAL));
  live.journeys.deictic.push(await turn("investigate it"));
  live.checks.push(check("deictic-investigate", live.journeys.deictic.at(-1).reply, /Demand Surge/i, STEAL));
  live.journeys.deictic.push(await turn("look deeper into it"));
  live.checks.push(check("deictic-deeper", live.journeys.deictic.at(-1).reply, /Demand Surge/i, STEAL));
  live.journeys.deictic.push(await turn("what else do we know about it?"));
  live.checks.push(check("deictic-what-else", live.journeys.deictic.at(-1).reply, /Demand Surge/i, STEAL));
  live.journeys.deictic.push(await turn("why?"));
  live.checks.push(check("deictic-why", live.journeys.deictic.at(-1).reply, /Demand Surge/i, STEAL));
  live.journeys.deictic.push(await turn("how sure are you?"));
  live.checks.push(check("deictic-sure", live.journeys.deictic.at(-1).reply, /Demand Surge/i, STEAL));
  live.journeys.deictic.push(await turn("what impact could it have?"));
  live.checks.push(check("deictic-impact", live.journeys.deictic.at(-1).reply, /Demand Surge/i, STEAL));
  live.journeys.deictic.push(await turn("Tell me more about Capacity Expansion Plan."));
  live.checks.push(check("deictic-explicit-change", live.journeys.deictic.at(-1).reply, /Capacity Expansion Plan/i, null));
