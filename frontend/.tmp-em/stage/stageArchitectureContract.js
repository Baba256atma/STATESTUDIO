 ...
 */
export const STAGE_ARCHITECTURE_VERSION = "PHASE-1/STAGE-ARCH-2";
export const STAGE_ARCHITECTURE_SOURCE = "phase-1-stage-architecture";
export const NEXORA_STAGE_ARCHITECTURE_LOG_PREFIX = "[NexoraStageArchitecture]";
...
export const STAGE_MINIMUM_OVERALL_SCORE = 95;
export const STAGE_MAX_RECOMMENDED_FILE_LINES = 150;
...
export const STAGE_DEPENDENCY_BOUNDARIES = Object.freeze([
    Object.freeze({
        name: "stage-types",
...
export function computeStageOverallScore(dimensions) {
    const weighted = dimensions.architecture * STAGE_SCORE_WEIGHTS.architecture +
...
export function meetsStageMinimumScore(overall) {
