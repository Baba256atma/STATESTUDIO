 ...
 */
export const EXECUTIVE_INTENT_REASONING_CANONICAL_EXAMPLES = Object.freeze([
    Object.freeze({
...
export function getExecutiveIntentReasoningCanonicalExample(exampleId) {
    return (EXECUTIVE_INTENT_REASONING_CANONICAL_EXAMPLES.find((entry) => entry.exampleId === exampleId) ??
        null);
}
