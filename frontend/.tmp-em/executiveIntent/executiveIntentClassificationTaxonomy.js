 ...
 */
export const EXECUTIVE_INTENT_CLASSIFICATION_TAXONOMY_VERSION = "APP-3/6-TAXONOMY-1";
...
export const INTENT_TAXONOMY_CLASS_DEFINITIONS = Object.freeze([
    Object.freeze({
        classId: "strategic",
        label: "Strategic",
        group: "strategic",
...
export function getIntentTaxonomyClassDefinition(classId) {
...
export function sortIntentClasses(classes) {
    const unique = [...new Set(classes)];
    return unique.sort((left, right) => INTENT_TAXONOMY_CLASS_ORDER.indexOf(left) - INTENT_TAXONOMY_CLASS_ORDER.indexOf(right));
}
export function isIntentTaxonomyClassKey(value) {
    return INTENT_TAXONOMY_CLASS_KEYS.includes(value);
}
