 ...
 */
export const EXECUTIVE_INTENT_CONTRACT_VERSION = "APP-3/1";
export const EXECUTIVE_INTENT_ARCHITECTURE_VERSION = "APP-3/1-arch";
export const EXECUTIVE_INTENT_API_VERSION = "APP-3/1";
export const EXECUTIVE_INTENT_SOURCE = "executive-intent-contract";
export const EXECUTIVE_INTENT_LOG_PREFIX = "[NexoraExecutiveIntent]";
export const EXECUTIVE_INTENT_PLATFORM = "nexora-type-c";
...
export const EXECUTIVE_INTENT_PRIORITY_RANK = Object.freeze({
    very_low: 0,
    low: 1,
    medium: 2,
    high: 3,
...
export const EXECUTIVE_INTENT_TERMINAL_STATUSES = Object.freeze(["completed", "cancelled", "archived"]);
export const EXECUTIVE_INTENT_TERMINAL_LIFECYCLE_STAGES = Object.freeze(["completed", "archived"]);
