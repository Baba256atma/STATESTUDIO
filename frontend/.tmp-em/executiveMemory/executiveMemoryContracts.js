...
import { EXECUTIVE_MEMORY_ARCHITECTURE_VERSION, EXECUTIVE_MEMORY_CATEGORY_KEYS, EXECUTIVE_MEMORY_CONTRACT_VERSION, EXECUTIVE_MEMORY_FUTURE_COMPATIBILITY, EXECUTIVE_MEMORY_FUTURE_PHASE_KEYS, EXECUTIVE_MEMORY_LOG_PREFIX, EXECUTIVE_MEMORY_MANDATORY_METADATA_FIELDS, EXECUTIVE_MEMORY_MUST_NOT_OWN, EXECUTIVE_MEMORY_PLATFORM, EXECUTIVE_MEMORY_RESERVED_MEMORY_IDS, EXECUTIVE_MEMORY_RESERVED_PROVIDER_IDS, EXECUTIVE_MEMORY_SOURCE, EXECUTIVE_MEMORY_TAGS, } from "./executiveMemoryConstants.ts";
import { isExecutiveMemoryCategory, validateExecutiveMemoryMetadataShape, validateExecutiveMemoryShape, } from "./executiveMemoryValidation.ts";
export { EXECUTIVE_MEMORY_ARCHITECTURE_VERSION, EXECUTIVE_MEMORY_CATEGORY_KEYS, EXECUTIVE_MEMORY_CONTRACT_VERSION, EXECUTIVE_MEMORY_FUTURE_COMPATIBILITY, EXECUTIVE_MEMORY_FUTURE_PHASE_KEYS, EXECUTIVE_MEMORY_LOG_PREFIX, EXECUTIVE_MEMORY_MANDATORY_METADATA_FIELDS, EXECUTIVE_MEMORY_MUST_NOT_OWN, EXECUTIVE_MEMORY_PLATFORM, EXECUTIVE_MEMORY_RESERVED_MEMORY_IDS, EXECUTIVE_MEMORY_RESERVED_PROVIDER_IDS, EXECUTIVE_MEMORY_SOURCE, EXECUTIVE_MEMORY_TAGS, isExecutiveMemoryCategory, validateExecutiveMemoryMetadataShape, validateExecutiveMemoryShape, };
export const EXECUTIVE_MEMORY_IDENTITY = Object.freeze({
    appId: "APP-4",
...
export function createExecutiveMemoryReferenceExample() {
...
export function createExecutiveMemoryTagExample() {
    return Object.freeze({
...
export function resolveExecutiveMemoryMetadataExample(timestamp = "2026-01-01T00:00:00.000Z") {
    return Object.freeze({
...
export function resolveExecutiveMemoryExample(timestamp = "2026-01-01T00:00:00.000Z") {
...
export function resolveExecutiveMemoryProviderExample(timestamp = "2026-01-01T00:00:00.000Z") {
    return Object.freeze({
        providerId: "executive-memory-foundation-provider",
        label: "Executive Memory Foundation Provider",
        version: "1.0.0",
        supportedCategories: Object.freeze(["decision", "evidence", "business_context"]),
        metadata: Object.freeze({ owner: "executive-memory-foundation", registeredAt: timestamp }),
        registeredAt: timestamp,
        readOnly: true,
    });
}
export function getExecutiveMemoryContractVersionMetadata() {
    return Object.freeze({
        contractVersion: EXECUTIVE_MEMORY_CONTRACT_VERSION,
        architectureVersion: EXECUTIVE_MEMORY_ARCHITECTURE_VERSION,
...
export function getExecutiveMemoryFutureCompatibility() {
