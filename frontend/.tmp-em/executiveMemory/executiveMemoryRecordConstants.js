 ...
 */
export const EXECUTIVE_MEMORY_RECORD_CONTRACT_VERSION = "APP-4/2";
export const EXECUTIVE_MEMORY_RECORD_SCHEMA_VERSION = "1.0.0";
export const EXECUTIVE_MEMORY_RECORD_ARCHITECTURE_VERSION = "APP-4/2-arch";
