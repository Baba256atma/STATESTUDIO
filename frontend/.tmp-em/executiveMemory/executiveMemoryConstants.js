 ...
 */
export const EXECUTIVE_MEMORY_CONTRACT_VERSION = "APP-4/1";
export const EXECUTIVE_MEMORY_ARCHITECTURE_VERSION = "APP-4/1-arch";
export const EXECUTIVE_MEMORY_API_VERSION = "APP-4/1";
export const EXECUTIVE_MEMORY_SOURCE = "executive-memory-foundation";
export const EXECUTIVE_MEMORY_LOG_PREFIX = "[NexoraExecutiveMemory]";
export const EXECUTIVE_MEMORY_PLATFORM = "nexora-type-c";
