...
import { createExecutiveMemoryBody, createExecutiveMemoryBusinessContext, createExecutiveMemoryHeader, createExecutiveMemoryMetadata, createExecutiveMemoryTag, createExecutiveMemoryVersion, } from "./executiveMemoryMetadata.ts";
...
export { createExecutiveMemoryReference, createExecutiveMemoryMetadata, createExecutiveMemoryRecord, };
const DEFAULT_TIME = "2026-01-01T00:00:00.000Z";
export function buildExecutiveMemoryRecordExample(timestamp = DEFAULT_TIME, category = "decision") {
    ...
    const body = createExecutiveMemoryBody({
        narrative: "Leadership approved a phased market expansion based on validated demand signals and risk review.",
